    ...
    return (
      <div className="dash-mini">
        <div className="dash-mini-toolbar">
          <button type="button" className="dash-mini-expand-btn" onClick={openTokenLaunch} title="Token Launch">
          ...
          <button type="button" className="dash-mini-expand-btn" onClick={toggleDashboardTab} title="Expand dashboard (Ctrl+Shift+D)">
            <ExpandIcon size={12} />
          </button>
        </div>
      ...
      {!activeMint ? (
        ...
        <>
          ...
          <div className="dash-mini-actions">
            <button type="button" className="dash-btn dash-btn-green" onClick={handleBuy}>Buy</button>
            <button type="button" className="dash-btn dash-btn-red" onClick={handleSell}>Sell</button>
            <button type="button" className="dash-btn dash-btn-muted" onClick={handleClaimFees}>Fees</button>
          </div>
        </>
      )}

      <div className="dash-mini-footer">
        <button type="button" className="dash-btn dash-btn-outline-full" onClick={openTokenLaunch}>
          Open Token Launch
        </button>
        {activeWalletId && (
          <button
