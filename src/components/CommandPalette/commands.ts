...
export function buildCommands(deps: CommandDeps): Command[] {
  ...
  const toolCommands: ToolCommandDefinition[] = [
    ...
    { commandId: 'nav:daemon-ai', label: 'Open DAEMON AI', toolId: 'daemon-ai' },
    { commandId: 'nav:project-readiness', label: 'Open Solana Start', toolId: 'project-readiness' },
    { commandId: 'nav:solana-toolbox', label: 'Open Solana Workflow', toolId: 'solana-toolbox' },
    { commandId: 'nav:integrations', label: 'Open Solana Integrations', toolId: 'integrations' },
    { commandId: 'nav:token-launch', label: 'Open Token Launch', toolId: 'token-launch' },
    { commandId: 'nav:block-scanner', label: 'Open Block Scanner', toolId: 'block-scanner' },
    { commandId: 'nav:replay-engine', label: 'Open Replay', toolId: 'replay-engine' },
