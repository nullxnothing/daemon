...
export const PLUGIN_REGISTRY: Record<string, PluginManifest> = {
  'imagegen': {
    ...
    icon: ImageGenIcon,
    component: lazy(() => import('../panels/plugins/ImageGen/ImageGen')),
  },
  'tweet-generator': {
    id: 'tweet-generator',
    name: 'Tweet Generator',
    description: 'Draft tweets with your voice profile',
    mountPosition: 'right-panel-tab',
    icon: TweetIcon,
  ...
  'remotion': {
    id: 'remotion',
    name: 'Remotion',
    description: 'Video editor via localhost Remotion',
    mountPosition: 'center-panel',
    icon: RemotionIcon,
    component: lazy(() => import('../panels/plugins/Remotion/Remotion')),
    companionPanel: lazy(() => import('../panels/plugins/Remotion/RemotionCompanion')),
  },
  'browser': {
    id: 'browser',
    name: 'Browser',
    description: 'Embedded browser view',
    mountPosition: 'right-panel-tab',
    icon: BrowserIcon,
    component: lazy(() => import('../panels/plugins/Browser/Browser')),
  },
  'gmail': {
    id: 'gmail',
    name: 'Gmail',
    description: 'Code catcher and inbox',
    mountPosition: 'right-panel-tab',
    icon: GmailIcon,
    component: lazy(() => import('../panels/plugins/Gmail/Gmail')),
  },
  'telegram': {
    id: 'telegram',
    name: 'Telegram',
    description: 'Full Telegram client',
    mountPosition: 'right-panel-tab',
    icon: TelegramIcon,
    component: lazy(() => import('../panels/plugins/Telegram/Telegram')),
  },
  'subscriptions': {
    id: 'subscriptions',
    name: 'Subscriptions',
    description: 'API subscription tracker',
    mountPosition: 'right-panel-tab',
    icon: SubscriptionsIcon,
    component: lazy(() => import('../panels/plugins/Subscriptions/Subscriptions')),
  },
  'morning-briefing': {
    id: 'morning-briefing',
    name: 'Morning Briefing',
    description: 'Overnight report overlay',
    mountPosition: 'overlay',
    icon: BriefingIcon,
    component: lazy(() => import('../panels/plugins/MorningBriefing/MorningBriefing')),
  },
  'services': {
    id: 'services',
    name: 'Services',
    ...
    mountPosition: 'right-panel-tab',
    icon: ServicesIcon,
    component: lazy(() => import('../panels/plugins/Services/Services')),
  },
}
