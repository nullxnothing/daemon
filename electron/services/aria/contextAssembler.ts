...
- Plain questions (current branch, project status, file contents, balances, "what is X?") are READ work: call the read tools above and answer directly yourself. NEVER call run_engine_action to answer a question — it is a write-gated orchestration tool and will interrupt the user with an approval card.
