...
contextBridge.exposeInMainWorld('daemon', {
  ...
  pro: {
    ...
    arenaSubmit: (input: { title: string; pitch: string; description: string; category: string; githubUrl: string; demoUrl?: string; xHandle?: string; discordHandle?: string }) => ipcRenderer.invoke('pro:arena-submit', input),
